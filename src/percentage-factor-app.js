...
const workspace=$("#pf-workspace"),chain=$("#pf-chain"),rate=$("#pf-rate"),hundredth=$("#pf-hundredth"),reduced=$("#pf-reduced"),decimal=$("#pf-decimal"),product=$("#pf-product"),warning=$("#pf-warning"),explore=$("#pf-explore"),conclusion=$("#pf-conclusion"),scenarioInput=$("#pf-scenario"),scenarioOutput=$("#pf-scenario-output"),insight=$("#pf-insight"),live=$("#pf-live"),next=$("#pf-next"),reset=$("#pf-reset");
...
function render(){
  ...
  rate.textContent=model.rateText;hundredth.textContent=model.hundredthText;reduced.textContent=model.reducedText;decimal.textContent=model.decimalText;product.textContent=model.productText;
  hundredth.hidden=!model.showHundredth;reduced.hidden=!model.showReduced;decimal.hidden=!model.showDecimal;product.hidden=!model.showProduct;warning.hidden=!model.showWarning;explore.hidden=!model.showExplore;conclusion.hidden=!model.showConclusion;
