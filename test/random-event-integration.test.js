...
test("das neue Kapitel bleibt bei Telefon, Tablet und Desktop ohne konkurrierendes Raster", () => {
  assert.match(css, /\.chapter-probability \.module-grid\s*\{[^}]*grid-template-columns:\s*1fr/s);
...
test("Cache v42, Pages, Smoke und Workflow enthalten genau die sechs K8.1-Laufzeitdateien", () => {
