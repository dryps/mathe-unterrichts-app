...
test("Kapitel-4-Raster bleibt mit drei Karten responsiv und gleichwertig", () => {
  assert.match(files.homeCss, /\.chapter-equations \.module-grid\s*\{[^}]*repeat\(3,\s*minmax\(0,\s*1fr\)\)/s);
